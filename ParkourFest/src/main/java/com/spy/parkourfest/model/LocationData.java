 ...
 * Stores world name separately to avoid holding World references.
 */
public class LocationData {
    ...
    /**
     * Create a LocationData from a Bukkit Location (world-agnostic).
     */
    ...
    /**
     * Create a LocationData from block coordinates (center of block top).
     */
    ...
    /**
     * Convert to a Bukkit Location using the world name from a StageData context.
     */
    public Location toBukkit(String worldName) {
        World world = Bukkit.getWorld(worldName);
        if (world == null) {
            throw new IllegalStateException("World '" + worldName + "' is not loaded!");
        }
        return toBukkit(world);
    }

    /**
     * Get the distance squared to another LocationData (for performance comparisons).
     */
