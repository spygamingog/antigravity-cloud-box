...
/**
 * Tab completer providing rich context-aware suggestions for all SpyMotion commands.
 */
public class SpyMotionTabCompleter implements TabCompleter {
    ...
    public SpyMotionTabCompleter(StructureManager structureManager) {
        this.structureManager = structureManager;
    }

    @Override
    public List<String> onTabComplete(@NotNull CommandSender sender, @NotNull Command command, @NotNull String alias, @NotNull String[] args) {
        if (!sender.hasPermission("spymotion.admin")) return List.of();
