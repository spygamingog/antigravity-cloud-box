...
import com.spy.spymotion.editor.pages.MechanicsWizardPage;
...
public class EditorSession {
    ...
    public void setActiveStructureId(String activeStructureId) {
        ...
        if (activeStructureId != null) {
            com.spy.spymotion.model.MovingStructureData sd = plugin.getStructureManager().getStructureData(activeStructureId);
            if (sd != null) {
    ...
    public EditorSession(SpyMotion plugin, Player player) {
        this.plugin = plugin;
    ...
    public SpyMotion getPlugin() { return plugin; }
